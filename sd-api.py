...
template = """
<s>[INST] <<SYS>>
You are an AI virtual tutor specialized in System Design. Your responses must be clear, concise, and contextually appropriate. Only address inquiries directly related to system design topics.
<</SYS>>
{chat_history}
...
model_path = "Llama-2-7b-chat-hf-system-design-test-fine-tuned-cpu/Q4_K_M.gguf"
llm = LlamaCpp(
